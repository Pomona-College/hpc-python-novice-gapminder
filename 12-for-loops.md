...
## Indentation Errors Are Common (But Easy to Fix)

Python's indentation requirement seems strict at first, but it makes code more readable. If you get an `IndentationError`, check that you used four spaces (or a tab, but not mixed). Most code editors can automatically convert tabs to spaces. This is a one-time configuration that will save you from indentation headaches.

...
Plotting and data analysis in Python with pandas and matplotlib. Adapted from Software Carpentry for Pomona College.

**Lesson site:** <https://pomona-college.github.io/hpc-python-novice-gapminder/>
...
Adapted from [swcarpentry/python-novice-gapminder](https://github.com/swcarpentry/python-novice-gapminder) by
...
The original lesson is maintained by Allen Lee, Nathan Moore, Sourav Singh and Olav Vahtras, with contributions from many others. Please cite the original lesson as set out in `CITATION`.
...
[swcarpentry/python-novice-gapminder](https://github.com/swcarpentry/python-novice-gapminder) so the wider community
benefits.
